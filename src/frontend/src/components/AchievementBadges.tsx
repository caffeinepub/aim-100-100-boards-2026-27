...
const streakBadges = [
  ...
  },
  {
    ...
    name: "60-Day Master",
    emoji: "💎",
    desc: "Study 60 days in a row",
  },
  {
    days: 90,
    name: "90-Day Legend",
    emoji: "👑",
    desc: "Complete the full 90-day sprint",
  },
];
        ...
        >
          ...
          {nextBadge && (
            <p className="text-white/60 text-xs mt-2">
              {nextBadge.threshold - overallPct}% more to unlock{" "}
            ...
            return (
              ...
              >
                <CardContent className="p-5">
                  <div
                    className={`relative mx-auto w-20 h-20 mb-3 ${earned ? "badge-animate" : ""}`}
                  >
                    <img
                      src={badge.image}
                      alt={badge.name}
                  ...
                  <div
                    className={`inline-block px-3 py-1 rounded-full text-white text-sm font-bold mb-2 bg-gradient-to-r ${badge.gradient}`}
                  >
                  ...
                  {!earned && (
                    <div className="mt-2">
                      <Progress
                        value={(overallPct / badge.threshold) * 100}
                        className="h-1"
                      />
                ...
                <CardContent className="p-4">
                  ...
                  {earned ? (
                    ...
                    <p className="text-xs text-muted-foreground mt-2">
                      {sb.days - longestStreak} more days
                    </p>
                  )}
                </CardContent>
              </Card>
