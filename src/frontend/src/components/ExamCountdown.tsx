    ...
    <div className="flex flex-col items-center">
      <div
        ...
        style={{
          ...
          border: "1px solid oklch(0.65 0.17 55 / 0.3)",
        }}
      >
        <span
...
const milestones = [
  {
    ...
    label: "1 Year to Go",
    emoji: "🌱",
    tip: "Build strong foundations. Master NCERT basics.",
  },
  {
    days: 180,
    label: "6 Months Left",
    emoji: "📚",
    tip: "Complete first reading of all subjects.",
  },
  {
    days: 90,
    label: "90 Days Sprint",
    emoji: "🚀",
    tip: "Start intensive revision and mock tests.",
  },
  {
    days: 60,
    label: "60 Days Push",
    emoji: "💪",
    tip: "Focus on weak areas and previous year papers.",
  },
  {
    days: 30,
    label: "1 Month Final",
    emoji: "⚡",
    tip: "Daily mock tests and formula revision.",
  },
  {
    days: 14,
    label: "2 Weeks Crunch",
    emoji: "🔥",
    tip: "Only revision — no new topics.",
  },
  {
    days: 7,
    label: "Final Week",
    emoji: "🎯",
    tip: "Light revision, stay calm, sleep well.",
  },
  {
    days: 1,
    label: "Tomorrow!",
    emoji: "🌟",
    tip: "Rest, prepare stationery, believe in yourself.",
  },
];

export default function ExamCountdown() {
  const { countdown, examDate, setExamDate, getMilestoneMessage } =
    useCountdown();
    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <Card className="premium-card overflow-hidden">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.12 0.01 260), oklch(0.17 0.015 260))",
          }}
        >
          ...
          {countdown.total <= 0 ? (
            <div className="py-8">
              ...
              <p className="text-white/70 mt-2">
                Give it your absolute best. You've got this!
              </p>
            </div>
          ) : (
            <>
              ...
              <p className="text-white/80 text-base font-medium italic">
                {getMilestoneMessage()}
              </p>
            </>
          )}
