    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.75 0.17 55), transparent)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, oklch(0.65 0.15 45), transparent)",
          }}
        />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div
              className="w-16 h-16 rounded-2xl flex items-center justify-center shadow-gold"
              style={{
                background:
                  "linear-gradient(135deg, oklch(0.65 0.17 55), oklch(0.78 0.15 65))",
              }}
            >
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                disabled={
                  loading || (auth.isFirstTime && password !== confirmPassword)
                }
                style={{
                  background:
