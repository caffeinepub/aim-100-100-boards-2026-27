...
import { Bell, CheckCheck, ExternalLink, Plus, Trash2 } from "lucide-react";
        ...
        <Card className="premium-card border-primary/30">
          ...
          <CardContent className="space-y-3">
            <div>
              ...
              <Input
                placeholder="New video: How to score 100 in Physics..."
                value={title}
          ...
          >
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                <div
                  className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${notif.isRead ? "bg-muted" : "bg-primary pulse-gold"}`}
                />
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <p
                      className={`font-medium text-sm ${notif.isRead ? "text-foreground" : "text-foreground font-semibold"}`}
                    >
                      {notif.title}
                    </p>
