...
export function useAIDoubtSolver() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: findAnswer is a stable pure function defined outside, safe to exclude
